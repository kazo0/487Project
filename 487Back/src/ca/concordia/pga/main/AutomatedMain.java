...
import ca.concordia.pga.models.Backtrack;
...
public class AutomatedMain {
	...
	public static void main(String[] args) {
		...
		// *******BEGIN BACKTRACKING***********
		Backtrack b = new Backtrack(pg);
		Vector<Service> solution = b.perform();
		// *******END BACKTRACKING*************
		

		
		// *******WRITE PLANNING GRAPH AND SOLUTION TO FILE (resources\output\result.txt)*************
